...
namespace Jarrus90\AdvancedCleanup\Console\Command;
...
class RemoveUnusedMediaCommand extends Command
{
    ...
    private function isInWatermarkPath(?string $file): bool
    {
        return strpos($file, '/watermark') !== false;
    }
}
